...
- Name: components/security-gates.spec.ts >> Admin page basic smoke tests >> admin dashboard page loads without server error
- Location: scripts/visual-regression/components/security-gates.spec.ts:4:7
