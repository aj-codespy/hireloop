      ...
      <body className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4 dark:bg-gray-900">
        <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          ...
          <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
            The application hit an unexpected error. Try again or reload.
          </p>
          {error.message && (
          ...
          <div className="flex flex-col gap-2">
            <button
              onClick={() => reset()}
              className="w-full rounded bg-[#F97316] py-2 text-sm font-semibold text-white transition hover:bg-[#EA6B2D]"
            >
              Try again
            </button>
            <button
