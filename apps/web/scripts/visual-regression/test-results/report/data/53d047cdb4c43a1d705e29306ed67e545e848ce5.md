...
- Name: components/security-gates.spec.ts >> Admin page basic smoke tests >> admin API keys page loads without server error
- Location: scripts/visual-regression/components/security-gates.spec.ts:9:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/admin/api-keys
Call log:
  - navigating to "http://localhost:3001/admin/api-keys", waiting until "load"
