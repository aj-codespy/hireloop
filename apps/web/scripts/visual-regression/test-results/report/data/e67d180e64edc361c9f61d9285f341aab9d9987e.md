...
- Name: components/security-gates.spec.ts >> Admin page basic smoke tests >> admin settings page loads without server error
- Location: scripts/visual-regression/components/security-gates.spec.ts:19:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3001/admin/settings
Call log:
