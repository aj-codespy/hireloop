...
target_ip = "35.79.125.133" # We can try 35.79.125.133 or 52.68.3.1
...
async def test():
    ...
    for port in ports:
        for pwd in passwords:
            for ip in ["35.79.125.133", "52.68.3.1"]:
                global target_ip
                target_ip = ip
                print(f"Trying IP={ip}, port={port}, password={pwd[:10]}...")
                try:
                    ...
                    print(f"★ SUCCESS! IP={ip}, port={port}, password={pwd[:10]}")
